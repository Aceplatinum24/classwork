...
# ## 8
# ## Modify the previous example to print elements 0,1,2,3. 
# (Hint: it’s not going to be [0:3], but it’s close to that.)
# thelist = ["water", "chair", "mug", "mouse"]
# print(thelist[0:])
...
# ## 17
# ## Modify the previous example to print the last letter of Sarah’s name 
# ## (using string indexing).


# ## 18
# ## Modify the previous example to print the last letter of the last name 
# ## in the list. Use negative indexing.
...
# names = ["Sarah", "Tom", "Harry", "Susan", "Becky"]
# id_num = int(input("What is your student ID? "))
# print(f"ID: {id_num} Name: {names[id_num]}")
...
# names = ["Sarah", "Tom", "Harry", "Susan", "Becky"]
# add_name = input("Which name would you like to add to the list? ")
...
# names = ["Sarah", "Tom", "Harry", "Susan", "Becky"]
# print(names)
# position = int(input("Enter the position of the name you want to remove: "))
# del names[position]
# print(names)
...
# ## to shown what the actual stopping number will be.  
# ## In this example the stop will occur at 10.
